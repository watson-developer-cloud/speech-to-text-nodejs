...
var INITIAL_OFFSET_Y = 30;
var fontSize = 16;
var delta_y = 2 * fontSize;
var radius = 5;
var space = 4;
var defaultFont = fontSize + "px Arial";
var boldFont = "bold " + fontSize + "px Arial";
...
WordAlternative.prototype.draw = function(x, y, width) {
	...
	ctx.font = italicFont;
	var conf = (this._confidence.toFixed(3) * 100).toFixed(1);
	var appendix = conf + '%';
	var rightOffset = ctx.measureText(appendix).width + 32;
...
var parseAlternative = function (element, index, array) {
...
var parseBin = function (element, index, array) {
